...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Apartment Carousel
        var ApartmentThumb = new Swiper(".apartment-text-carousel", {
            slidesPerView: 3,
            slidesPerGroup: 1,
            spaceBetween: 0,
            loop: true,
        ...
        var apartments = new Swiper(".apartment-thumb-carousel", {
            slidesPerView: 3,
            slidesPerGroup: 1,
            spaceBetween: 0,
            loop: true,
        ...
        var swiperTesti = new Swiper(".testi-carousel-3", {
            ...
            speed: 600,
            navigation: {
                nextEl: ".testi-carousel-3 .swiper-prev",
                prevEl: ".testi-carousel-3 .swiper-next",
            },
            pagination: {
                el: ".swiper-pagination",
                clickable: true,
        ...
        function scrollTopPercentage() {
            const scrollPercentage = () => {
                ...
                scrollElementWrap.css("background", `conic-gradient( var(--bd-color-theme-primary) ${scrollValue}%, var(--bd-color-common-white) ${scrollValue}%)`);
